...
if VERSION < v"1.3.0-rc4"
    ...
    error("Unable to import ISL_jll on Julia versions older than 1.3!")
end
...
artifacts = Pkg.Artifacts.load_artifacts_toml(artifacts_toml; pkg_uuid=UUID("9a84b867-ccd3-531b-bb38-095e36150902"))
platforms = [Pkg.Artifacts.unpack_platform(e, "ISL", artifacts_toml) for e in artifacts["ISL"]]
...
if best_platform === nothing
    @debug("Unable to load ISL; unsupported platform $(triplet(platform_key_abi()))")
else
